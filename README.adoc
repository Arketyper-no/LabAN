...
|23.08.2016|    0.2 |BNA|Hele   |Andre utkast - etter møte 23.aug 
|===
...
Første workshop vil bli i uke 37 og vil ha mapping mot KITH-svarbrev som utgangspunkt. Trenger sikkert ytterligere to workshops på dette. 
